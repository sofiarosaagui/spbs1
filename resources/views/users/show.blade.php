...
<form class="row g-3 needs-validation" novalidate action="/users/delete/{{$user->id}}" method="POST">
  @csrf
  @method('DELETE')
  ...
  {{-- <div class="col-md-3">
    ...
    <div class="col-md-3">
      ...
      <input type="text" class="form-control" id="validationCustom02" name="name" value="{{$user->name}}" disabled>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
    ...
    <div class="col-md-3">
      ...
      <input type="text" class="form-control" id="validationCustom03" name="last_name" value="{{$user->last_name}}" disabled>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
    <div class="col-md-3">
      <label for="validationCustom04" class="form-label">Teléfono del usere</label>
      <input type="tel" class="form-control" id="validationCustom04" name="phone"  placeholder="0000000000" maxlength="20" value="{{$user->phone}}" disabled>
    ...
    <div class="col-md-6">
      ...
      <input type="text" class="form-control" id="validationCustom05" name="address" value="{{$user->address}}" disabled>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
    ...
    <div class="col-md-3">
      <label for="validationCustom07" class="form-label">Tipo</label>
      <select class="form-select" id="validationCustom07" name="type" disabled>
...
<div class="col-md-6">
  ...
  <input type="email" class="form-control" id="validationCustom05" name="email" value="{{$user->email}}" disabled>
  <div class="valid-feedback">
    Looks good!
  </div>
</div>
