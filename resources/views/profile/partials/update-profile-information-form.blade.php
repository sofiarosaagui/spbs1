    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <select id="type" name="type" class="mt-1 block w-full" required autocomplete="type">
                ...
                <option value="CLIENTE" @if(old('type', $user->type) == 'CLIENTE') selected @endif>CLIENTE</option>
            </select>
        ...
        <div>
            ...
            <select id="status" name="status" class="mt-1 block w-full" required autocomplete="status">
                <option value="Activo" @if(old('status', $user->status) == 'Activo') selected @endif>Activo</option>
                <option value="Inactivo" @if(old('status', $user->status) == 'Inactivo') selected @endif>Inactivo</option>
            </select>
