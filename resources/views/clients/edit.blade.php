...
<form class="row g-3 needs-validation" novalidate action="/clients/update/{{$client->id}}" method="POST">
  @csrf
  @method('PUT');
  ...
  {{-- <div class="col-md-3">
    ...
    <div class="col-md-3">
      ...
      <input type="text" class="form-control" id="validationCustom02" name="name" value="{{$client->name}}" required>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
    ...
    <div class="col-md-3">
      ...
      <input type="text" class="form-control" id="validationCustom03" name="last_name" value="{{$client->last_name}}" required>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
    <div class="col-md-3">
      ...
      <input type="tel" class="form-control" id="validationCustom04" name="phone"  placeholder="0000000000" maxlength="20" value="{{$client->phone}}" required>
    ...
    <div class="col-md-6">
      ...
      <input type="text" class="form-control" id="validationCustom05" name="address" value="{{$client->address}}" required>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
    ...
    <div class="col-md-3">
      ...
      <input style="color: white" type="file" class="form-control" id="validationCustom06" name="image" accept="image/*" required>
      <div class="invalid-feedback">
        Looks good!
      </div>
    </div>
