...
<form class="row g-3 needs-validation" novalidate action="/suppliers/delete/{{$supplier->id}}" method="POST">
  @csrf
  @method('DELETE')
    {{-- <div class="col-md-3">
    ...
    <div class="col-md-3">
      ...
      <input type="text" class="form-control" id="validationCustom02" name="name" value="{{$supplier->name}}" disabled>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
    <div class="col-md-3">
      ...
      <input type="text" class="form-control" id="validationCustom03" name="rfc" maxlength="18"  value="{{$supplier->rfc}}" disabled>
      <div class="valid-feedback">
        Looks good!
      </div> --}}
    ...
    <div class="col-md-3">
      ...
      <input type="tel" class="form-control" id="validationCustom04" name="phone"  placeholder="0000000000" maxlength="20" value="{{$supplier->phone}}" disabled>
    ...
    <div class="col-md-6">
      ...
      <input type="text" class="form-control" id="validationCustom05" name="address" value="{{$supplier->address}}" disabled>
      <div class="valid-feedback">
    ...
    <div class="col-md-3">
      ...
      {{-- <input type="file" class="form-control" id="validationCustom06" name="image"  accept="image/*" maxlength="130" disabled> --}}
      <div class="invalid-feedback">
        Looks good!
      </div>
    </div>
